...
WebUI.doubleClick(findTestObject('DeleteSingleItem'))

WebUI.waitForAlert(10, FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementText(findTestObject('Popups/Empty Cart/PopUpMessageText'), 'Are you sure you want to delete The X-Files: Season Two on the cart?')
