...
WebUI.check(findTestObject('Pages/Baskets/BasketItemCheckBox_a'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.doubleClick(findTestObject('Pages/Baskets/ActionButton/Compare'))
