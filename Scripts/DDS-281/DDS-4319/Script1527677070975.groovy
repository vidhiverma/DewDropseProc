...
import com.kms.katalon.core.webui.keyword.builtin.VerifyElementClickableKeyword as VerifyElementClickableKeyword
...
if (WebUI.verifyElementClickable(findTestObject('Empty cart')) == true) {
    WebUI.doubleClick(findTestObject('Pages/CartPage/Empty Cart'))

    WebUI.doubleClick(findTestObject('Popups/Empty Cart/Yes Button'))
}

if(WebUI.verifyElementNotClickable(findTestObject('Pages/CartPage/Empty Cart'))==true) {
